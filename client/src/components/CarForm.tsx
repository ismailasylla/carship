...
const CarForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const carData: Car = {
      ...
      vin: form.vin, // Added VIN field
    };

    try {
      await dispatch(addCar(carData)).unwrap(); // Ensure successful dispatch
      toast.success("Car details added successfully!"); // Show success message
      navigate("/"); // Redirect to homepage
    } catch (error) {
      console.error("Failed to add car:", error);
      toast.error("Failed to add car. Please try again."); // Show error message
    }
  };
